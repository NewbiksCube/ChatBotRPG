...
def add_new_tab(self, name=None, log_file=None, notes_file=None, context_file=None, system_context_file=None, thought_rules_file=None, purpose=None, variables_file=None, theme_settings=None, replace_existing_index=None, skip_heavy_loading=False):
    ...
    applies_to_narrator_radio = QRadioButton("Player Post")
    ...
    applies_to_narrator_radio.setToolTip("Rule actions affect the Player's post response/context.")
    applies_to_character_radio = QRadioButton("Character Post")
    ...
    applies_to_end_of_round_radio = QRadioButton("End of Round")
    applies_to_end_of_round_radio.setObjectName("AppliesToEndOfRoundRadio")
    applies_to_end_of_round_radio.setFont(QFont('Consolas', 11))
    applies_to_end_of_round_radio.setToolTip("Rule actions execute once at the end of the round after all characters have posted.")
    ...
    applies_to_group.addButton(applies_to_end_of_round_radio)
    applies_to_layout.addWidget(applies_to_narrator_radio)
    applies_to_layout.addWidget(applies_to_character_radio)
    applies_to_layout.addWidget(applies_to_end_of_round_radio)
    ...
    def update_top_splitter_visibility(checked):
        ...
        if hasattr(output_field, 'get_message_roles'):
            message_roles = output_field.get_message_roles()
            if message_roles:
